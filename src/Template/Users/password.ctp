    ...
    <div class="card-body">
        <div class="users form">
            ...
            <fieldset>
                ...
                <?php
                echo $this->Form->control('current_password', ['label' => 'Current Password', 'class' => 'form-control']);
                echo $this->Form->control('new_password', ['label' => 'New Password', 'class' => 'form-control']);
                echo $this->Form->control('confirm_password', ['label' => 'Confirm Password', 'class' => 'form-control']);
                ?>
            </fieldset>
            <?= $this->Form->button(__('Save Changes'), ['class' => 'form-control']) ?>
            <?= $this->Form->end() ?>
        </div>
    </div>
</div>
