 ...
 * PeepsFixture
 */
class PeepsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'repeatPass' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'repeatPass' => 'Lorem ipsum dolor sit amet',
                'created' => '2024-03-01 04:37:55',
                'modified' => '2024-03-01 04:37:55',
            ],
        ];
        parent::init();
    }
